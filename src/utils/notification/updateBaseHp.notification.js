...
const updateBaseHpNotification = (user, opponent) => {
    ...
    const userResponse = createResponse(PacketType.UPDATE_BASE_HP_NOTIFICATION, RESPONSE_SUCCESS_CODE, {
        isOpponent: false,
        basehp: user.basehp,
    });
    ...
    const opponentResponse = createResponse(PacketType.UPDATE_BASE_HP_NOTIFICATION, RESPONSE_SUCCESS_CODE, {
        isOpponent: true,
        basehp: user.basehp,
    });
